...
额外的窗格会被列出，但一些新窗格可能会以各种状态列出，如运行但未就绪，或映像就绪和容器创建，如图 [2-11](#Fig11) 所示。
...
`hello-world`吊舱被列出，如图 [2-20](#Fig20) 所示。最初，Pods 可能没有准备好- > 1/1。就绪列值“0/1”意味着 Pod 中的 1 个容器中的 0 个已经就绪。
