...
在以下示例中，将创建一个负载均衡器，该负载均衡器只能由 IP 地址来自 130.210.207.1 和 130.210.207.2 的客户端访问，如图 [6-41](#Fig41) 所示。
...
| 集装箱强制策略 | 黑鸭，白源 | 这些有助于识别开发人员使用的开源库中的任何安全漏洞，并确保开发人员不违反任何开源许可。 |
